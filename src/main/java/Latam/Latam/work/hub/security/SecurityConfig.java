    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/users/desactivate-account/*").hasAnyRole("CLIENTE", "PROVEEDOR", "ADMIN")
                        ...
                        .requestMatchers("/api/location/*").hasAnyRole("CLIENTE", "PROVEEDOR","ADMIN")
                        ...
                        .requestMatchers("/api/auth/change-rol").hasRole("ADMIN")
